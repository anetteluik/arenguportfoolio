<template>
    <div class="popUpTextAndButtons">
        <div class="popUpTextAndButtonsWrapper">
            <div class="text">Sissejuhatus tarkvaraarendusse</div>
            <p class="textP">Õppisin tundma mitmeid tarkvaraarenduse metoodikaid, sealhulgas kosemudelit, Scrum'i,
                Kanbani ja teisi. Nende metoodikate uurimine aitas mul paremini mõista erinevaid lähenemisviise projekti
