<template>
    <div class="popUpTextAndButtons">
        <div class="popUpTextAndButtonsWrapper">
            <div class="text">Asjaajamise alused</div>
            <p class="textP">Asjaajamise aluste tundides koostasin ametlike dokumente neile sobivas vormingus (näiteks
                CV, motivatsioonikiri ning avaldus). Tutvusin Google Docsi <i>shortcut</i>ide ja mallidega, millest ma polnud
                varem kuulnudki, kuigi olen platvormi mitmeid kordi kasutanud.
                Digiallkirjastamise protsess oli mulle juba tuttav, kuid selle olulisus dokumendihalduses muutub
                tänapäeval üha ilmsemaks ja vajalikumaks. Praktikas harjutasin e-kirja koostamist praktikakoha
                taotlemiseks ning kõikide vajalike dokumentide ja lisade vormistamist.
            </p>
        </div>
    </div>
...
import Brain from '@/assets/img/asjaajamine.webp';
