<template>
    <div class="popUpTextAndButtons">
        <div class="popUpTextAndButtonsWrapper">
            <div class="text">Töötamise õiguslikud alused</div>
            <p class="textP">Õppisin töölepingute sõlmimisest ja mõlema poole kohustustest selles protsessis. Lisaks
                uurisin erinevaid viise töölepingu lõpetamiseks ja sellega seotud seaduslikke nõudeid. Samuti sain
                ülevaate töösuhete rahalistest aspektidest, sealhulgas palgast, lisatasudest ja hüvitistest.
            </p>
        </div>
    </div>
...
import Contract from '@/assets/img/contract.webp';

const popUpImages = ref(null)

const images = [Contract]
