    ...
    <div class="popUpTextAndButtons">
        <div class="popUpTextAndButtonsWrapper">
            ...
            <p class="textP">Selle kursuse jooksul õppisin veebilehe struktuuri põhialuseid, nagu joondus, pealkirjad,
                ...
                teada, kuidas erinevad atribuudid mõjutavad komponentide asetust ja joondusi.
                ...
                kasutamisest.
                Tutvusin erinevate lehe validaatoritega, nagu W3C HTML validator ja BeautifyTools CSS validatorURL, mis
                ...
                <br><br>
                Siin on näha kõiki <a
                    href="https://drive.google.com/drive/folders/1QkQhibe4URXncU0EIcvr125G2hgfeFHA?usp=drive_link" target="_blank">koodiga
                    kirjutatud veebilehti</a>, mille selle kursuse jooksul lõin.
            </p>
        </div>
    </div>
